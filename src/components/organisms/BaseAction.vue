<template>
  <UseDynamicAction :to="to">
    <div
      ...
      class="ml-16 min-h-[48px] p-2 relative w-56 group overflow-hidden cursor-pointer disabled:opacity-30 disabled:pointer-events-none focus:outline-none focus-visible:ring focus-visible:ring-focus bg-[length:200%_100%] bg-[position:100%] bg-button-background"
      :class="$_color"

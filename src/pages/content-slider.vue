<template>
  <o-05-01-content-slider :data="slider" />
</template>

<script>
import O0501ContentSlider from '../components/organisms/o-05-01-content-slider.ce.vue'
export default {
  components: { O0501ContentSlider },
  data() {
    return {
      slider: {
        content: {

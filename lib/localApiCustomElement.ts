...
export function defineCustomElement<Props, RawBindings = object>(setup: (props: Readonly<Props>, ctx: SetupContext) => RawBindings | RenderFunction, config?: DefineCustomElementConfig): VueElementConstructor<Props>;
...
>(options: ComponentOptionsWithoutProps<Props, RawBindings, D, C, M, Mixin, Extends, E, EE> & { styles?: string[] }, config?: DefineCustomElementConfig): VueElementConstructor<Props>;
...
export function defineCustomElement<
    ...
    EE extends string = string
>(options: ComponentOptionsWithArrayProps<PropNames, RawBindings, D, C, M, Mixin, Extends, E, EE> & { styles?: string[] }, config?: DefineCustomElementConfig): VueElementConstructor<{ [K in PropNames]: any }>;
...
export function defineCustomElement<
    ...
    E extends EmitsOptions = Record<string, any>,
    EE extends string = string
>(options: ComponentOptionsWithObjectProps<PropsOptions, RawBindings, D, C, M, Mixin, Extends, E, EE> & { styles?: string[] }, config?: DefineCustomElementConfig): VueElementConstructor<ExtractPropTypes<PropsOptions>>;
...
export function defineCustomElement(options: any, config?: DefineCustomElementConfig, hydrate?: RootHydrateFunction): VueElementConstructor {
...
export class VueElement extends BaseClass {
    ...
    constructor(private _def: InnerComponentDef, private _props: Record<string, any> = {}, private _config: DefineCustomElementConfig = {}, hydrate?: RootHydrateFunction) {
        super();
        this._config = extend(
            {
                shadowRoot: true,
